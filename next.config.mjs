        ...
        headers: [
          {
            ...
            value: [
              ...
              `script-src 'self' 'unsafe-inline'${is_dev ? " 'unsafe-eval'" : ""} https://vlibras.gov.br`,
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
              "font-src 'self' https://fonts.gstatic.com",
              "img-src 'self' data: https://lh3.googleusercontent.com https://res.cloudinary.com https://vlibras.gov.br",
